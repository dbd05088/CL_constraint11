...
# CIL CONFIG
NOTE="ours_use_cutmix_ratio_square" # Short description of the experiment. (WARNING: logs/results with the same note will be overwritten!)
MODE="ours"
...
do
    ...
    --memory_size $MEM_SIZE $GPU_TRANSFORM --online_iter $ONLINE_ITER --use_human_training $HUMAN_TRAINING \
